...
/*心得:
這次寫這個程式，讓我練習了密碼驗證、選單設計、巢狀迴圈以及錯誤輸入處理等基本技巧， 
在畫直角三角形和顯示乘法表的功能中，我熟悉了使用迴圈控制輸出的方式，也學會了如何
讓使用者重新輸入正確的資料， 整體來說，這次練習讓我更了解流程控制和條件判斷在實
際應用上的重要性，也提升了我寫程式時處理細節的能力， 希望在未來能讓程式結構更
完整，進一步加強錯誤處理和版面美化。
*/ 
